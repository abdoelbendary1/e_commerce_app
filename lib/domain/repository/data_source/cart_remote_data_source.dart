...
abstract class CartRemoteDataSource {
  Future<Either<Failures, GetCartDataResponseEntity>> getCart();
   Future<Either<Failures, GetCartDataResponseEntity>> deleteCartItem( {required String productID});
  Future<Either<Failures, GetCartDataResponseEntity>> updateCartItem( {required String productID,required int count});
}
